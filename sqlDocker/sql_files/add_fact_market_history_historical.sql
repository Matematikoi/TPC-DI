...
--- 
---CompanyEarnings AS (
---	SELECT DISTINCT SK_CompanyID, Total_EPS
...
----FROM High_Low HL, raw.DailyMarket DM, DimSecurity DS, CompanyEarnings CE, DimDate DD1, DimDate DD2, DimDate DD3
----WHERE HL.DM_S_SYMB = DS.Symbol and DS.IsCurrent=1
...
---AND DS.EffectiveDate <= DM.DM_DATE AND DM.DM_DATE < DS.EndDate
-- High_Low--
